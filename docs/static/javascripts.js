...
function actionMail() {
	...
	sendMail(	"507rydbp@anonaddy.com",
				"Anfrage zum MS Blog", 
 ...
 * 11.05.2025 error handling in decrypt
 * 
 **/

 
const user =(function () {
	const genAuth = _hash("Familie Stumpp 2024", "Michas Blog");
 ...
 * 
 * Usage:
 * 			<ms-crypted style='display:none' class='' data-content='{"iv":"6G8flQ1qYDA0Y6Od9hQXoA==","v":1,"iter":10000,"ks":128,"ts":64,"mode":"ccm","adata":"","cipher":"aes","salt":"JvVF4YIncdo=","ct":"9xgi/Qb/hfI9vgRneGlFonh5+3D8arXlVi4hFlTZNIgC1kgjG3UX"}'>Content is encrypted.<br>Inhalt ist verschlüsselt.<br>El contenido está encriptado.</ms-crypted>
 * 
...
/** user.js
 *
 * Liste der Benutzer, die sich anmelden können.
 * FAMILIE STUMPP
 * https://blog.stumpp.name
 * code: 0217
 **/

const user_data = [
	{ user: "D9aFtPkhDcOBJAx/8m8+QpjzhQR1PAt7sCAFYPHNgg0=", hash: "QGf8AF7uHl5LNnmf57Vlya+GRGSywg2T1Pux5a6oZ7Y=", code: "FWU6EBUbVgICGBsiIgofa3oofVh+RwNJQw8mUComIW5C" }, 	// "anja"
	{ user: "3aOIgwNcKFuvRw5KpQIKl4obD953yh/hvowulN1vSik=", hash: "YIfmsJnZqTW3EuN2lE/m2rOyPJG1+7Iz5Uy8o2tLC6E=", code: "Yj0VGwZLKiIGLgc2NTN2MAIMO3AjSzslC1oEUh8jE1NB" }, 	// "anke"
	{ user: "SbGRz4E/pioqKAyge2gS3yO+PzwkN2BOf80t7nLx9Sc=", hash: "Mm66xzLcJraopqLUD7C8PARhDaHbcjhvaMJ13iBgfCU=", code: "BDkaBx9yOmMpGkslcSwbAx1pNz9JF3ZFE1gbOW5pMSgc" }, 	// "gilbert"
	{ user: "tUqVEnpLVz9B4zX9vTOdzCII+/sa4Lb6t1mdbi1ux1Q=", hash: "MgAOFAyevpungmn/R5tYb693rArePw9/e1qFTlWDp6Y=", code: "LQYuCCQdLTIHN1g1cCMlCDtnPTNEPRIBR1o3IHJgRUoS" }, 	// "ian"
	{ user: "VkvFb7Xq746F+yig0/WjBz71MAZYmlNfTuKcDdUvZmg=", hash: "C3RLx8oKSVpC0s8oYH299Lp6BppgEzDqeNCNih907hA=", code: "DzcgEAtmOgF5UQgYUklUV34DJwUtTRFgLwQpaFQmBjoF" }, 	// "inga"
	{ user: "9ANBk877alPv9j2+omlgdJVxt8TRglSGbtgXe22TRqk=", hash: "d3CIXKe4Cu0ab6+4a5gQZeBUe9MN1dw/eclCCo2SvE4=", code: "YwYTHAoFZn8/Cm9FChtYZxRTAlFfIycZFFgaFBkEZhQ0" }, 	// "juliane"
	{ user: "p6d68B/IUDcEZkQ2lMWJNFYOVae+JIycs59bgIZQMS8=", hash: "WcvW0nT+ZS9LheAh6mdKCID0Ks4hdgp11n3G1Epz58k=", code: "K2Uha1kyGS1jfCFqEz4VUSkXPBt8KhQYHC8jcgUfGAZY" }, 	// "katja"
	{ user: "uccpABExdtx56ptYFHcjyq5G1+TfJ0T/5IKVvZR9NaQ=", hash: "xMxmoMpH9eA9LJWKZTyZcWf/oqt4Sgxz7F+pp/9e/94=", code: "KDAgIigxIgQQLjR8SBAfJWhwHxgkKHk/VV4jVxIFZHVf" }, 	// "mareike"
	{ user: "tvjUNKhH+w8MGo2bk2uMqVLiJPIFpV9LqbLCD4j9yec=", hash: "SOmeCDQnlRtEUg11Q/RwXF3W0O0BDJnz8S/KkrFbtTo=", code: "KSUpFic8EjF4JHQmA1dDRyF2FmwVIHkfCzIZFx4fZRYx" }, 	// "martin"
	{ user: "uc+BSwFfYrkcPMmBdwwevwbJO3wMKvewWlWWV6Xyh3o=", hash: "31uHijmONb/u2HIuaVMUwYa7euiAAYn9sTSfgGKlARI=", code: "KDBjAD4GKVUXORghOgwTMQMjNhA4CxE5Jl0MNwU9WhgW" }, 	// "mayumi"
	{ user: "04aBB0RnwLwUexepoSue+ozBC89UX1sLzMz1qTxKK3k=", hash: "xb0aqKPiJzC9YOfcJz2EwGzg2cR57Y5PGLONIa5q0Jk=", code: "dG4/GCMHegg3AlUAFwgrCygxEQdZDDswOhRUIwh1V3It" }, 	// "thomas"
	{ user: "O+tGDlbqhBueuf2KKX+mgFYumh0z33VAR5wu0DerSIM=", hash: "jCAvlTJ+FwnI1nysnauNKvg5d4KuABEQz94Ivyhm4Lo=", code: "C3YnGSUkUggkDgsAHwN7NjwqVlInBRNZGwJ9K1RZJXwj" }, 	// "tobias"
/** admin **/
	{ user: "vPqDz+JzZvwdpB/9bNG1yWTdrPCBZUSP/rLRObiSF30=", hash: "qXWr00AzrxRl/xsz0LsvWtKaxNxRi7YLza++ace/BOY=", code: "KwsjGxtdGgseDFwuChhZTgY+BR5ANRojQykUFj4nAxNt" } 	// "micha"

];
 
		// <!-- user_data Tabelle mit allen Benutzern -->
